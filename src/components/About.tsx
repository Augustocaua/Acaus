        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Tornando a IA{" "}
              <span className="text-gradient">acessível, humana e estratégica</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group p-8 rounded-2xl bg-card border border-border hover:border-copper transition-all duration-300 hover:shadow-[0_10px_40px_-10px_hsl(20_48%_54%/0.3)] animate-fade-in"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className="w-14 h-14 rounded-xl bg-gradient-copper-purple flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
