      ...
      <main>
        ...
        <section className="py-20 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <Reveal delay={200}>
                <p className="text-lg text-muted-foreground">Nossa missão é mudar isso.</p>
              </Reveal>
              <Reveal delay={300}>
                <p className="text-lg text-muted-foreground">
        ...
        <section className="py-12 bg-background">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <Reveal delay={100}>
              <p className="text-lg text-muted-foreground mb-8">Somos especialistas em transformar rotinas e aumentar resultados através de:</p>
            </Reveal>
            <div className="space-y-8">
              <div>
                <Reveal delay={200}>
                  <h3 className="text-xl font-semibold">Landing pages e sites que realmente convertem</h3>
                </Reveal>
                <Reveal delay={250}>
                  <p className="text-muted-foreground">Páginas feitas com método, tecnologia e narrativa estratégica — criadas para vender 24h por dia.</p>
                </Reveal>
              </div>
              <div>
                <Reveal delay={300}>
                  <h3 className="text-xl font-semibold">Automação com IA personalizada</h3>
                </Reveal>
                <Reveal delay={350}>
                  <p className="text-muted-foreground">Fluxos que organizam atendimentos, reduzem tarefas repetitivas e devolvem tempo ao empreendedor.</p>
                </Reveal>
              </div>
              <div>
                <Reveal delay={400}>
                  <h3 className="text-xl font-semibold">Soluções digitais sob medida</h3>
                </Reveal>
                <Reveal delay={450}>
                  <p className="text-muted-foreground">Integrações, sistemas simples, páginas para eventos, captação de leads e muito mais.</p>
                </Reveal>
              </div>
            </div>
            <Reveal delay={500}>
        ...
        <section className="py-12 bg-background">
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <Reveal delay={200}>
              <p className="text-muted-foreground mb-4">Sua visão desde o início foi clara:</p>
            </Reveal>
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              ...
              <Reveal delay={350}><li>Criar sistemas que economizem tempo, aumentem lucros e organizem a rotina.</li></Reveal>
